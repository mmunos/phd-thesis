...
\def\ycoors{{4.5 , 4 , 3.5 , 3 , 0.5 , 0 , 2.5 , 2 , 1.5 , 1 , 5 , 5.3}}
...
%		\node at (\xcoors[0],\ycoors[11]) {$\Stream \ \ \  :$};
		...
		\rectang{\xcoors[2]}{0.95}{0.7}{1.1};
		\rectang{\xcoors[3]}{0.95}{0.7}{1.1};
		\rectang{\xcoors[4]}{0.95}{0.7}{1.1};
		\rectang{\xcoors[5]}{0.95}{0.7}{1.1};
		\rectang{\xcoors[6]}{0.95}{0.7}{1.1};
		
		\rectang{\xcoors[3]}{0.95}{2.7}{1.9};
		\rectang{\xcoors[5]}{0.95}{2.7}{1.9};
...
%		\node (labelT2_1x3) at (\xcoors[0],\ycoors[9]) {\footnotesize$q_1,\textsf{X},q_p$};
		
		\node (S_11_1) at (\xcoors[1],\ycoors[0]) {\tiny$S^1_{q_1,q_1}\!\!: \eps$};
		
		\node (S_11_2) at (\xcoors[2],\ycoors[0]) {\tiny$S^2_{q_1,q_1}\!\!: \eps$};
		\node (S_22_2) at (\xcoors[2],\ycoors[1]) {\tiny$S^2_{q_2,q_2}\!\!: \eps$};
		
		\node (S_11_3) at (\xcoors[3],\ycoors[0]) {\tiny$S^3_{q_1,q_1}\!\!: \eps$};
		\node (S_22_3) at (\xcoors[3],\ycoors[1]) {\tiny$S^3_{q_2,q_2}\!\!:\eps$};
		
		\node (S_11_4) at (\xcoors[4],\ycoors[0]) {\tiny$S^4_{q_1,q_1}\!\!: \prod(T^3_{q_1,\textsf{X},q_1},S^3_{q_1,q_1})$};
		\node (S_22_4) at (\xcoors[4],\ycoors[1]) {\tiny$S^4_{q_2,q_2}\!\!:\prod(T^3_{q_2,\textsf{X},q_2},S^3_{q_2,q_2})$};
		\node (S_13_4) at (\xcoors[4],\ycoors[2]) {\tiny$S^4_{q_1,q_3}\!\!:\prod(T^3_{q_1,\textsf{X},q_2},S^3_{q_2,q_2},(\triangleleft,3))$};
		
		\node (S_11_5) at (\xcoors[5],\ycoors[0]) {\tiny$S^5_{q_1,q_1}\!\!: \eps$};
		\node (S_22_5) at (\xcoors[5],\ycoors[1]) {\tiny$S^5_{q_2,q_2}\!\!:\eps$};
		\node (S_33_5) at (\xcoors[5],\ycoors[3]) {\tiny$S^5_{q_3,q_3}\!\!:\eps$};
		
		\node[black!40] (S_11_6) at (\xcoors[6],\ycoors[0]) {\tiny$S^6_{q_1,q_1}\!\!: \prod(T^5_{q_1,\textsf{X},q_1},S^5_{q_1,q_1})$};
		\node (S_22_6) at (\xcoors[6],\ycoors[1]) {\tiny$S^6_{q_1,q_1}\!\!:\prod(T^5_{q_2,\textsf{X},q_2},S^5_{q_2,q_2})$};
		\node (S_13_6) at (\xcoors[6],\ycoors[2]) {\tiny$S^6_{q_1,q_3}\!\!:\union($};
		\node (S_13_6a) at (\xcoors[6],\ycoors[2]-0.5) {\tiny$\prod(T^5_{q_1,\textsf{X},q_2},S^5_{q_2,q_2},(\triangleleft,5))$};
		\node (S_13_6b) at (\xcoors[6],\ycoors[2]-1) {\tiny$\prod(T^5_{q_1,\textsf{X},q_3},S^5_{q_3,q_3}))$};
		

		\node[black!40] (S_11_7) at (\xcoors[7],\ycoors[0]) {\tiny$S^7_{q_1,q_1}\!\!: \prod(T^6_{q_1,\textsf{X},q_1},S^6_{q_1,q_1})$};
		\node (S_13_7) at (\xcoors[7],\ycoors[2]) {\tiny$S^7_{q_1,q_3}\!\!:\union($};
		\node (S_13_7a) at (\xcoors[7],\ycoors[2]-0.5) {\tiny$\prod(T^6_{q_1,\textsf{X},q_2},S^6_{q_2,q_2},(\triangleleft,6))$};
		\node (S_13_7b) at (\xcoors[7],\ycoors[2]-1) {\tiny$\prod(T^6_{q_1,\textsf{X},q_3},S^6_{q_3,q_3}))$};
		
		\node (T1_1x1_2) at (\xcoors[2], \ycoors[4]) {\scriptsize$T^2_{q_1,\textsf{X},q_1}\!\!: S^1_{q_1,q_1}$};
%		\node[text width=1.65cm,anchor=north west,execute at begin node=\setlength{\baselineskip}{0.5em},align=right] (T1_1y2_2) at (\xcoors[2]-0.85, \ycoors[5]+0.55) {\scriptsize$T^2_{q_2,\textsf{Y},q_2}\!\!:\prod(\,\,$ $\ \ S^1_{q_1,q_1}, (\triangleright,1))$};
		\node(T1_1y2_2) at (\xcoors[2], \ycoors[5]) {\tiny$T^2_{q_1,\textsf{Y},q_2}\!\!:\prod(S^1_{q_1,q_1},(\triangleright,1))$};
		
		\node (T1_1x1_3) at (\xcoors[3], \ycoors[4]) {\tiny$T^2_{q_1,\textsf{X},q_1}$};
		\node(T1_1y2_3) at (\xcoors[3], \ycoors[5]) {\tiny$T^2_{q_1,\textsf{Y},q_2}$};
		
		\node (T1_1x1_4) at (\xcoors[4], \ycoors[4]) {\tiny$T^2_{q_1,\textsf{X},q_1}$};
		\node(T1_1y2_4) at (\xcoors[4], \ycoors[5]) {\tiny$T^2_{q_1,\textsf{Y},q_2}$};
		
		\node (T1_1x1_5) at (\xcoors[5], \ycoors[4]) {\tiny$T^2_{q_1,\textsf{X},q_1}$};
		\node(T1_1y2_5) at (\xcoors[5], \ycoors[5]) {\tiny$T^2_{q_1,\textsf{Y},q_2}$};
		
		\node (T1_1x1_6) at (\xcoors[6], \ycoors[4]) {\tiny$T^2_{q_1,\textsf{X},q_1}$};
		\node(T1_1y2_6) at (\xcoors[6], \ycoors[5]) {\tiny$T^2_{q_1,\textsf{Y},q_2}$};
		
		
		\node (T2_1x1_3) at (\xcoors[3], \ycoors[6]) {\tiny$T^3_{q_1,\textsf{X},q_1}\!\!: S^2_{q_1,q_1}$};
		\node (T2_1y2_3) at (\xcoors[3], \ycoors[7]) {\tiny$T^3_{q_1,\textsf{Y},q_2}\!\!:\prod(S^2_{q_1,q_1},(\triangleright,2))$};
		\node (T2_2x2_3) at (\xcoors[3], \ycoors[8]) {\tiny$T^5_{q_2,\textsf{X},q_2}\!\!:S^2_{q_2,q_2}$};
		
		\node[black!40] (T2_1x1_5) at (\xcoors[5], \ycoors[6]) {\tiny$T^5_{q_1,\textsf{X},q_1}\!\!:S^4_{q_1,q_1}$};
		\node (T2_1y2_5) at (\xcoors[5], \ycoors[7]) {\tiny$T^5_{q_1,\textsf{Y},q_3}\!\!:\prod(S^4_{q_1,q_1},(\triangleright,4))$};
		\node (T2_2x2_5) at (\xcoors[5], \ycoors[8]) {\tiny$T^5_{q_2,\textsf{X},q_2}\!\!:S^2_{q_2,q_2}$};
		\node (T2_1x3_5) at (\xcoors[5], \ycoors[9]) {\tiny$T^5_{q_1,\textsf{X},q_3}\!\!:S^4_{q_1,q_3}$};
