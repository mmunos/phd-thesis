...
\committeememberB {Pablo Barceló}
\guestmemberA            {Gonzalo Navarro}
\guestmemberB            {Nicole Schweikardt}
\ogrsmember                 {Sergio Maturana}
...
\input{./chapters/nested/relatedwork}
...
\section{Application: Document Spanners} \label{gram:sec:spanners}
 ...
 \input{./chapters/grammars/relatedwork}
